...
export class I18nService {
  ...
  init(defaultLanguage: string, supportedLanguages: string[]) {
    ...
    this.initLibTranslations();
    // this.dateAdatper.setLocale(defaultLanguage);
  }
  initLibTranslations() {
    const appHuHu = this.translateService.translations['hu-HU'];
    delete appHuHu['COMMON'];
    const extendedHuHU = Object.assign({ ...huHU }, appHuHu);
  ...
  set language(language: string) {
    ...
    // this.dateAdatper.setLocale(language);
  }
